...
void function InitCharactersPanel( var panel )
{
	...
	{
		AddPanelFooterOption( panel, RIGHT, KEY_E, true, "", "`1%[|E]%`0 Execution", ExecutionShowcaseUI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_Y, true, "", "`1%[|Y]%`0 Select Character", CharSelectV2UI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_R, true, "", "`1%[|R]%`0 Get Skin Data", ShowSkinInfoUI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_B, true, "", "`1%[|B]%`0 Lobby View", LobbyShowcaseUI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_G, true, "", "`1%[|G]%`0 Message", LaunchDebugMessage )
		AddPanelFooterOption( panel, RIGHT, KEY_V, true, "", "", ToggleUI_Characters, null )
	}
