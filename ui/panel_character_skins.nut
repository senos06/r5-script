...
void function InitCharacterSkinsPanel( var panel )
{
	...
	{
		AddPanelFooterOption( panel, RIGHT, KEY_V, true, "", "", ToggleUI_CharacterSkins, null )
		AddPanelFooterOption( panel, RIGHT, KEY_F, true, "", "`1%[|F]%`0 Newest Skin", CNewestSkin_UI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_D, true, "", "`1%[|D]%`0 Next Skin", CSkinUP_UI, null )
 		AddPanelFooterOption( panel, RIGHT, KEY_S, true, "", "`1%[|S]%`0 Prev Skin", CSkinDOWN_UI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_C, true, "", "`1%[|C]%`0 Apply Camo", CCamo_Apply_UI )
		AddPanelFooterOption( panel, RIGHT, KEY_Z, true, "", "`1%[|Z]%`0 Prev Camo", CCamo_Down_UI )
		AddPanelFooterOption( panel, RIGHT, KEY_X, true, "", "`1%[|X]%`0 Next Camo", CCamo_Up_UI )
	}
