...
void function InitWeaponSkinsPanel( var panel )
{
	...
	{
		AddPanelFooterOption( panel, RIGHT, KEY_V, true, "", "", ToggleUI_Weapon, null )
		AddPanelFooterOption( panel, RIGHT, KEY_F, true, "", "`1%[|F]%`0 Newest Skin", WNewestSkin_UI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_D, true, "", "`1%[|D]%`0 Next Skin", WSkinUP_UI, null )
 		AddPanelFooterOption( panel, RIGHT, KEY_S, true, "", "`1%[|S]%`0 Prev Skin", WSkinDOWN_UI, null )
		AddPanelFooterOption( panel, RIGHT, KEY_G, true, "", "`1%[|G]%`0 Apply Camo", WCamo_Apply_UI )
		AddPanelFooterOption( panel, RIGHT, KEY_H, true, "", "`1%[|H]%`0 Prev Camo", WCamo_Down_UI )
		AddPanelFooterOption( panel, RIGHT, KEY_J, true, "", "`1%[|J]%`0 Next Camo", WCamo_Up_UI )
	}
}
